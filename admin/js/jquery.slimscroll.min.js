        ...
        slimScroll: function(h) {
            ...
            this.each(function() {
                ...
                if (b.parent().hasClass(a.wrapperClass)) {
                    ...
                    w();
                    if (f.isPlainObject(h)) { if ("height" in h && "auto" == h.height) { b.parent().css("height", "auto");
                            b.css("height", "auto"); var q = b.parent().parent().height();
                            b.parent().css("height", q);
                            b.css("height", q) } if ("scrollTo" in h) n = parseInt(a.scrollTo);
                        else if ("scrollBy" in h) n += parseInt(a.scrollBy);
                        else if ("destroy" in h) { c.remove();
                            g.remove();
                            b.unwrap(); return }
                        m(n, !1, !0) }
                } else {
                    ...
                    a.railDraggable && c.bind("mousedown", function(a) {
                        ...
                        b.bind("mouseup.slimscroll", function(a) { y = !1;
                            p();
                            b.unbind(".slimscroll") });
                        return !1
